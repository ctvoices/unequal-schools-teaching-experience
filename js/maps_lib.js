...
var MapsLib = {
  ...
  fusionTableId:      "1uALE95EBXMFsyQljDvPY3wy6NrJck8s_bONDIsjp", //Point data layer
 ...
 /* var type_column = "'Type'";  // -- note use of single & double quotes for two-word column header
    ...
    var type_column = "'Teacher Experience Quintile'";
    var searchType = type_column + " IN (-1,";
    if ( $("#cbType1").is(':checked')) searchType += "5,";
    if ( $("#cbType2").is(':checked')) searchType += "4,";
    if ( $("#cbType3").is(':checked')) searchType += "3,";
    if ( $("#cbType4").is(':checked')) searchType += "2,";
    if ( $("#cbType5").is(':checked')) searchType += "1,";
